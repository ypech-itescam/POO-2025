...
public class BlocDeNotas {
    ...
    public BlocDeNotas(int capacidad) {
        ...
        setCapacidad();
        numNotas = 3;
        notas[0] = new Nota("03/03/2025", "Realizar mi tarea de programación", "04/03/2024");
        notas[1] = new Nota("05/03/2025", "Hacer un ensayo", "06/03/2025");
        notas[2] = new Nota("12/03/2025", "Debatir con Santiago a cerca de la inexistencia del racismo inverso", "12/03/2024");
        c = new Color("morado");
    }
